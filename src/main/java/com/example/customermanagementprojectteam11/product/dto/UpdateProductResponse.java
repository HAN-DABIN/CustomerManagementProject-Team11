...
public class UpdateProductResponse {
    ...
    public UpdateProductResponse(String productName, ProductCategory category, long price, long stock, ProductStatus status, LocalDateTime createAt, LocalDateTime updateAt) {
